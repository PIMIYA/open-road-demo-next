...
const theme = createTheme({
  ...
  typography: {
    fontFamily: '"Manrope", ui-sans-serif, system-ui, sans-serif, "Apple Color Emoji", "Segoe UI Emoji"',
    fontSize: 14,
    fontWeightLight: 300,
    ...
    fontWeightBold: 500,
    h1: {
      fontFamily: '"Fraunces", "Noto Sans TC", "PingFang TC", "Microsoft JhengHei", ui-sans-serif, system-ui, sans-serif',
      fontSize: '32px',
      fontWeight: 700,
      textTransform: 'uppercase',
      letterSpacing: '0.05em',
